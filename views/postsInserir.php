...
?>
    <form class="max-w-4xl mx-auto mt-10 mb-10 bg-white p-8 rounded-2xl shadow-md" action="#" method="post" enctype="multipart/form-data">
        ...
        <textarea class="w-full mt-1 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" name="conteudo" id="conteudo" rows="10" column="200"></textarea>
